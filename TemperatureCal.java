    ...
    {             
        ...
        for(int row =0; row<4; row++) {
            for(int column = 0; column<1; column++){
                sumSun+= temps[row][column]; 
            }
            for(int column = 1; column<2; column++){
                sumMon+= temps[row][column]; 
            }
            for(int column = 2; column<3; column++){
                sumTue+= temps[row][column]; 
            }
            for(int column = 3; column<4; column++){
                sumWed+= temps[row][column]; 
            }
            for(int column = 4; column<5; column++){
                sumThu+= temps[row][column]; 
            }
            for(int column = 5; column<6; column++){
                sumFri+= temps[row][column];
            }
            for(int column = 6; column<7; column++){
                sumSat+= temps[row][column];
            }
        }
        int aSun = sumSun/4; 
        ...
        for(int row =0; row<1; row++){
            for (int column=0; column<7; column++){
                sum7Am+= temps[row][column];  
            }
        }
        for(int row =1; row<2; row++){
            for (int column=0; column<7; column++){
                sum3Pm+= temps[row][column];  
            }
        }
        for(int row =2; row<3; row++){
            for (int column=0; column<7; column++){
                sum7Pm+= temps[row][column];  
            }
        }
        for(int row =3; row<4; row++){
            for (int column=0; column<7; column++){
                sum3Am+= temps[row][column];  
            }
        } 
        int aSAm = sum7Am/ 7; 
        out.println("\n7:00 AM : " + aSAm); 
